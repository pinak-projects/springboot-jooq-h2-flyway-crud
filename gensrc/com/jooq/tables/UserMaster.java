...
public class UserMaster extends TableImpl<UserMasterRecord> {
    ...
    private static final long serialVersionUID = 1874765347;
    ...
    /**
     * The column <code>user_master.name</code>.
     */
    public final TableField<UserMasterRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(20), this, "");
